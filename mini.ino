...
void loop()
{
    ...
    float proxSensSJ = analogRead(IRcolorSJ);//Serial.println(proxSensSJ);
    float proxSensDJ = analogRead(IRcolorDJ);//Serial.println(proxSensDJ);
    float proxSensSS = analogRead(IRcolorSS);//Serial.println(proxSensSS);
    float proxSensDS = analogRead(IRcolorDS);//Serial.println(proxSensDS);
    ...
    Serial.println(cmL);
    //Serial.println(CheckState(SJ));
    //Serial.println(CheckState(DJ));
    //Serial.println(CheckState(StS));
    //Serial.println(cmDS);
    /*Serial.print("Left IRSensor :");
    Serial.print(cmL);
    Serial.print("\n");
    Serial.print("Right IRSensor :");
    Serial.print(cmR);
    Serial.print("\n");
    Serial.print("SJ IR :");
    Serial.print(cmSJ);
